            ...
            <nav className='navbar'>
                <ul className='ul'>
                    <li className='nav-list'>
                        <p className='logo'>ShopyGirl <img src={logo} alt='logo' className='logoImg'/></p>
                    </li>
